...
public class ReplyItemAdapter extends RecyclerView.Adapter<ReplyItemAdapter.ViewHolder> {
    ...
    public ReplyItemAdapter(Context mContext, List<CommunityReplyBean> data, OnDeleteClick click) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.tvContent.setText("回复内容：" + data.get(position).getContent());
    ...
    public interface OnDeleteClick {
        void OnDeleted(CommunityReplyBean replyBean);
    }
}
